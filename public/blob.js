...
const RADIUS_SIZE = window.innerWidth / 3
const BLOB_COLOR = '#0A0A0A'
...
class Blob {
  ...
  get radius() {
    return this._radius || RADIUS_SIZE
  }
...
init = function () {
  ...
  canvas.setAttribute('id', '__blob')
  // canvas.setAttribute('class', 'scale-0')
